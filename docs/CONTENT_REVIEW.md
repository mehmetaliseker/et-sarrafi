...
- Gizlilik metninin güncel barındırma/erişim kayıtları ve Google Maps kullanımına uygunluğu işletme tarafından incelenmelidir.

Kaynak kayıtları `src/data/sources.ts` ve ürün verilerinde korunur. Yayın ve kurulum bilgileri [README.md](../README.md) içindedir.
