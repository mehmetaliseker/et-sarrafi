...
export default function NotFound() {
  return <Container><div className="not-found"><p className="eyebrow">404 / Sayfa bulunamadı</p><h1 className="display-title">{editorial.notFound.title}</h1><p className="body-copy">{editorial.notFound.description}</p><div className="flex flex-wrap gap-3"><LinkButton href="/">Ana sayfa</LinkButton><LinkButton href="/urunler" variant="secondary">Ürünlerimiz</LinkButton></div></div></Container>;
}
