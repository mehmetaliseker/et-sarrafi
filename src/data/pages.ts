...
export const editorial = {
  about: { title: "Foça’dan gelen meslek birikimi.", paragraphs: [siteConfig.company.story, siteConfig.company.operations], operationsTitle: "Faaliyet alanlarımız", operations: [{ title: "Yetiştirme ve besi", text: siteConfig.company.farms, href: "/tesislerimiz" }, { title: "Kırmızı et işleme", text: siteConfig.company.operations, href: "/tesislerimiz#ornekkoy" }, { title: "Kurumsal tedarik", text: siteConfig.company.supply, href: "/iletisim" }] },
