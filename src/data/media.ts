...
export const brandAssets: { logo: { src: string; alt: string } | null; favicon: string | null } = { logo: { src: "/media/et-sarrafi-logo.webp", alt: "Et Sarrafı" }, favicon: "/media/et-sarrafi-logo.webp" };
