...
import { HeroRotatingText, HeroScrollCue } from "@/components/sections/HeroMotion";
...
export function Hero() {
  ...
  return <section className="home-hero" aria-labelledby="hero-title">
    ...
    <div className="hero-content"><div className="hero-copy">
      ...
      <HeroRotatingText />
      <div className="hero-actions"><LinkButton href="/urunler">Ürünleri İncele<Arrow /></LinkButton><LinkButton variant="text" href="/iletisim">İletişime Geç</LinkButton></div>
